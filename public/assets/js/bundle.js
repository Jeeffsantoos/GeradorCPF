...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    key: "isSequecia",
    value: function isSequecia() {
      var sequecia = this.cpfLimpo[0].repeat(this.cpfLimpo.length);
